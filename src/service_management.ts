...
var sm:OOW.ServiceManager = new OOW.ServiceManager();

sm.registerService("kunda.prdel", function () { return new OOW.ServiceBase(); });

console.log(sm.getServiceByPath("kunda.prdel"))